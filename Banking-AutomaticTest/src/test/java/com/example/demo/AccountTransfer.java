...
public class AccountTransfer {
	...
	@Test(priority = 34, description = " This test is for Account transfer setup")
	...
	@Test(priority = 35, description = " This test is for Customer login ")
	...
	@Test(priority = 36, description = " This test is for Account transfer  ")
	public void Transfer() throws InterruptedException {
		...
		WebElement accountsopen = driver.findElement(By.xpath("//a[@routerlink ='/transfer']"));
		accountsopen.click();
		Thread.sleep(3000);

		WebElement fromAcctNo = driver.findElement(By.name("fromAcctNo"));
		fromAcctNo.sendKeys("1004450652");
		
		WebElement toAcctNo = driver.findElement(By.name("toAcctNo"));
		toAcctNo.sendKeys("1004450752");
	...
	@Test(priority = 37, description = " This test is for Admin login approve")
	...
	@Test(priority = 38, description = " This test is for Account transfer approve")
	public void AdminCustApprove() throws InterruptedException {
		...
		approvals.click();
		Thread.sleep(3000);
		WebElement custapprovals = driver.findElement(By.xpath("//a[@routerlink='/approvals/transferapprove']"));
	...
	@Test(priority = 39, description = " This test is for Account transfer close")
